...
from aset_parsql.parsql import ColumnToken, SQLGroupType, SQLStatement, SQLToken, SQLTokenGroup

DOCUMENT_ID = "doc_id"


def rewrite_query(columns: List[ColumnToken], parsed: SQLStatement) -> Tuple[List[ColumnToken], str]:
    """Rewrites a given user-specified SQL query to a valid SQL query that can be executed on the ASET cache DB.
