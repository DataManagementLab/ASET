...
class ASETPipeline(BaseConfigurableElement):
    """
    ...
    def __eq__(self, other) -> bool:
        return isinstance(other, ASETPipeline) and self._pipeline_elements == other._pipeline_elements
    ...
    @classmethod
    def from_config(cls, config: Dict[str, Any]) -> "ASETPipeline":
        """
