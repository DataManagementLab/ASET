...
class BaseSignal(abc.ABC):
    """
    Signals for ASETNuggets, ASETAttributes, and ASETDocuments.

    Signals are values that can be set for a given data object (e.g. ASETNugget), but do not necessarily need to be set
...
@register_signal
class TreePredecessorSignal(BaseUntypedSignal):
    """Parent of an ASETNugget in a tree of ASETNuggets."""
    identifier: str = "TreePredecessorSignal"
    do_serialize: bool = False
