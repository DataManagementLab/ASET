"""
Nobel Price Winners Dataset - date_of_birth
===========================================
...
def load_dataset() -> List[Dict[str, Any]]:
    ...
    This method requires the .json files in the "datasets/nobel_date_of_birth/documents/" folder.
    """
