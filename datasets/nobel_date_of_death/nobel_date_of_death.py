"""
Nobel Price Winners Dataset - date_of_death
===========================================
...
def load_dataset() -> List[Dict[str, Any]]:
    ...
    This method requires the .json files in the "datasets/nobel_date_of_death/documents/" folder.
    """
