"""
Nobel Price Winners Dataset - field_of_work
===========================================
...
def load_dataset() -> List[Dict[str, Any]]:
    ...
    This method requires the .json files in the "datasets/nobel_field_of_work/documents/" folder.
    """
