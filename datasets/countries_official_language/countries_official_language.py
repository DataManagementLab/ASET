"""
Countries Dataset - official_language
=====================================
...
NAME: str = "countries_official_language"
...
def load_dataset() -> List[Dict[str, Any]]:
    ...
    This method requires the .json files in the "datasets/countries_official_language/documents/" folder.
    """
